...
Bob->Alice : hello
@enduml'
plantuml(sequenc_state, 'Simple sequence diagram')

```

A slight changes of this function will give us capacity to control the figure size

```{r generate_state_diagram_fun2, fig.width=4, fig.height=5}
